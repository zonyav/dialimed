...
NOISE = {
    "", "нет", "неуказан", "неуказано", "отсутствует", "неизвестно", "n/a", "na",
    "none", "null", "нетданных", "неопределен", "производитель", "изготовитель",
    "unknown",
}
GENERIC = re.compile(
...
BARE_NUMBER = re.compile(r"^(?:№|N|No|стр\.?|п\.?|поз\.?)?\s*\d{1,10}$", re.I)
